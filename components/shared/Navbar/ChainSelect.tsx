...
export function ChainSelect() {
  ...
  return (
    <Listbox value={selected} onChange={setSelected}>
      ...
      <ListboxOptions
        anchor="bottom"
        className="w-48 absolute mt-1 z-50 max-h-60 overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm"
      >
